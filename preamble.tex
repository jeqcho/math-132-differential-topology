% preamble.tex — Shared preamble for Math 132 Lecture Notes
...
% Proposition: Amber
\definecolor{propbg}{HTML}{FFF8E1}
\definecolor{propframe}{HTML}{F57F17}
...
\newtcbtheorem[use counter from=definition]{proposition}{Proposition}{
    enhanced, breakable,
    colback=propbg, colframe=propframe, colbacktitle=propframe, coltitle=white,
    fonttitle=\bfseries, boxrule=1pt, arc=2pt,
    left=8pt, right=8pt, top=6pt, bottom=6pt,
    attach boxed title to top left={yshift=-2mm, xshift=4mm},
    minipage boxed title*=-8mm,
